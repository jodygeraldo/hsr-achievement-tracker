...
export function AchievementHeader() {
	...
	return (
		<div className="sticky top-[calc(4rem+1px)] z-10 -mx-4 -mt-6 flex flex-col gap-4 bg-opacity-75 px-4 py-6 backdrop-blur backdrop-filter sm:-mx-6 sm:rounded-lg lg:-mx-6">
			<Progress.Root
